CREATE EXTERNAL TABLE IF NOT EXISTS `project-bd10f83d-812d-48fb-93c.bronze_dataset_maya.orders`(
    order_id INT64,
    customer_id INT64,
    order_date STRING,
...
-------------------------------------------------------------------------------------------------------------
-- Suppliers Table
CREATE EXTERNAL TABLE IF NOT EXISTS `project-bd10f83d-812d-48fb-93c.bronze_dataset_maya.suppliers` (
    supplier_id INT64,
...
CREATE EXTERNAL TABLE IF NOT EXISTS `project-bd10f83d-812d-48fb-93c.bronze_dataset_maya.product_suppliers` (
    supplier_id INT64,
    product_id INT64,
...
CREATE OR REPLACE EXTERNAL TABLE `project-bd10f83d-812d-48fb-93c.bronze_dataset_maya.customer_reviews` (
  id STRING,
  customer_id INT64,
  product_id INT64,
  rating INT64,
...
OPTIONS (
  format = 'PARQUET',
  uris = ['gs://datalake-project-bkt-22082026/landing/customer_reviews/customer_reviews_*.parquet']
);
